...
# checkpoint_dir = FLAGS.checkpoint_dir + 'tf_log_grad_mag-' + str(FLAGS.use_mag) + '_' + FLAGS.architecture + '_train'
# eval_dir = FLAGS.eval_dir + 'tf_log_grad_mag-' +str(FLAGS.use_mag) +FLAGS.architecture + '_' + FLAGS.eval_data

# checkpoint_dir = FLAGS.checkpoint_dir + 'trainonall_'+ str(FLAGS.num_tags)+'tags_' + str(FLAGS.tag_id) + '_'+ FLAGS.architecture + '_train'
# eval_dir = FLAGS.eval_dir +'trainonall_'+ str(FLAGS.num_tags)+'tags_' + str(FLAGS.tag_id) + '_'+ FLAGS.architecture + '_' + FLAGS.eval_data

checkpoint_dir = FLAGS.checkpoint_dir + 'trainonall_' + str(FLAGS.num_tags) + 'tags_' + FLAGS.architecture + '_train'
eval_dir = FLAGS.eval_dir +'trainonall_'+ str(FLAGS.num_tags)+'tags_' + FLAGS.architecture + '_' + FLAGS.eval_data
