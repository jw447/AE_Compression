...
DATA_PATH = '../data/SyntheticScatteringData_multi_crops'
DATA_PATH_BIN = DATA_PATH + 'BIN_log_32'
ALL_TAG_FILE = '../data/2tags_meta.txt'
ALL_TAG_META = []
...
def getAllLabel():
    ...
    label_all = Parallel(n_jobs=num_cores/2)(delayed(_getLabel_one_dir)(os.path.join(DATA_PATH,dir_names)) for dir_names in dirs)
